...
public class IdWorker {
	...
	private long pid = Long.parseLong(java.lang.management.ManagementFactory.getRuntimeMXBean().getName().split("@")[0]);

    private static class LazyHolder {
        private static final IdWorker INSTANCE = new IdWorker(1, 2);
    }
    ...
    private IdWorker(long workerId, long datacenterId) {
        ...
        if (datacenterId > this.maxDatacenterId || datacenterId < 0) {
            throw new IllegalArgumentException(String.format(
                    "datacenter Id can't be greater than %d or less than 0", this.maxDatacenterId));
        }
    ...
    public synchronized long nextId() {
        ...
        // 时间戳改变，毫秒内序列重置
            ...
            this.sequence = (long) (Math.random()*(10L-1L));
        }
        ...
        return timestamp - this.twepoch << this.timestampLeftShift
                ...
                | this.pid << String.valueOf(this.pid).length()
                | this.sequence;
    }
